...
\begin{document}
	...
	%%%%%%% Daten Versuch
	\setcounter{versuchnr}{221}
	\newcommand{\versuchtitel}{Adiabatenkoeffizient}
	\newcommand{\protocolpdf}{files/221messprotokoll.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau.png}
	\newcommand{\betreuer}{Laura Scholl}
	\newcommand{\datum}{26.11.2024}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{\titleimg}
