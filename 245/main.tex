...
\begin{document}
	...
	%%%%%%% Daten Versuch
	\setcounter{versuchnr}{245}
	\newcommand{\versuchtitel}{Induktion}
	\newcommand{\protocolpdf}{files/245messprotokoll.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau.png}
	\newcommand{\betreuer}{Selina Pohl}
	\newcommand{\datum}{05.11.2024}
  ...
  \includepdf[scale=0.83,pages={2,3,5},pagecommand={\thispagestyle{plain}}]{\protocolpdf}
	...
	\includepdf[scale=0.95,pages=1,pagecommand=\section*{Python Code, Hauptprogramm}]{files/245_auswertung.pdf}
	\includepdf[scale=0.95,pages=2-,pagecommand={\thispagestyle{plain}}]{files/245_auswertung.pdf}
