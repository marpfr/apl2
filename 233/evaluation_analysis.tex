...
\abbref{fig:ds_theorie_beugungsbild} zeigt das theoretische Beugungsbild des Doppelspalts, generiert mit dem in der Praktikumsanleitung gegebenen Python-Skript. 
...
Verringert man die Breite des Analysierspalt weiter, so verschwimmen beim Objektbild mit der Zeit die zwei Maxima zu einer \glqq{}Gauß-ähnlichen\grqq{} Funktion mit einem Plateau, wie ein \abbref{fig:ds_praxis_objektbild_plateau} zu sehen.
...
Auch das theoretische Objektbild lässt sich an diese Form annähern, indem man bei der numerischen Integration das $n$ in der oberen Integrationsgrenze langsam gegen $0$ gehen lässt. \abbref{fig:ds_theorie_objektbild_annaeherung_plateau} zeigt diese Annäherung, ausgehend vom Wert $n = 0.305$ in absteigenden Schritten von $0.002$ bis zum Wert $n = 0.283$.
...
Da in unserem experimentell bestimmten Bild noch kein perfektes Plateau, sondern noch zwei minimale \glqq{}Peaks\grqq{} zu sehen sind, entscheiden wir uns für den Wert $n = (0.295 \pm 0.002)$, für die beste Beschreibung der experimentellen Daten.
