...
\begin{document}
	...
	\newcommand{\versuchtitel}{Statistik des radioaktivenZerfalls}
	\newcommand{\protocolpdf}{files/251messprotokoll.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau.png}
	\newcommand{\betreuer}{Selina Pohl}
	\newcommand{\datum}{12.11.2024}
  ...
  \includepdf[scale=0.83,pages=2-,pagecommand={\thispagestyle{plain}}]{\protocolpdf}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\includepdf[scale=0.95,pages=1,pagecommand=\section*{Python Code, Hauptprogramm}]{files/Versuch_251-RG_MP.pdf}
	\includepdf[scale=0.95,pages=2-,pagecommand={\thispagestyle{plain}}]{files/Versuch_251-RG_MP.pdf}
