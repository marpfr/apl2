...
\begin{document}
	...
	%%%%%%% Daten Versuch
	\setcounter{versuchnr}{252}
	\newcommand{\versuchtitel}{Aktivierung mit thermischen Neutronen}
	\newcommand{\protocolpdf}{files/252messprotokoll.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau.png}
	\newcommand{\betreuer}{Pia Sophie Haas}
	\newcommand{\datum}{19.11.2024}
  ...
  % \includepdf[scale=0.83,pages=2-,pagecommand={\thispagestyle{plain}}]{\protocolpdf}
	...
	\includepdf[scale=0.95,pages=1,pagecommand=\section*{Python Code, Hauptprogramm}]{files/Versuch_252_Mabert.pdf}
	\includepdf[scale=0.95,pages=2-,pagecommand={\thispagestyle{plain}}]{files/Versuch_252_Mabert.pdf}
