...
\begin{document}
	...
	%%%%%%% Daten Versuch
	\setcounter{versuchnr}{234}
	\newcommand{\versuchtitel}{Lichtquellen und Gitterspektroskopie}
	\newcommand{\protocolpdf}{files/messprotokoll234.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau.png}
	\newcommand{\betreuer}{Henri Valentin Lurtz}
	\newcommand{\datum}{12.02.2025}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{\titleimg}
  ...
  \includepdf[scale=0.83,pages=2-,pagecommand={\thispagestyle{plain}}]{\protocolpdf}
	...
	\includepdf[scale=0.95,pages=1,pagecommand=\section*{Python Code, Hauptprogramm}]{files/234auswertung.pdf}
	\includepdf[scale=0.95,pages=2-,pagecommand={\thispagestyle{plain}}]{files/234auswertung.pdf}
