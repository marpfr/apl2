...
\begin{document}
	...
	\newcommand{\versuchtitel}{Röntgenfluoreszenz}
	\newcommand{\protocolpdf}{files/messprotokoll256.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau.png}
	\newcommand{\betreuer}{Valentin Krems}
	\newcommand{\datum}{17.02.2025}
  ...
  %\includepdf[scale=0.83,pages=2-,pagecommand={\thispagestyle{plain}}]{\protocolpdf}
	...
	\includepdf[scale=0.95,pages=1,pagecommand=\section*{Python Code, Hauptprogramm}]{files/auswertung256.pdf}
	\includepdf[scale=0.95,pages=2-,pagecommand={\thispagestyle{plain}}]{files/auswertung256.pdf}
