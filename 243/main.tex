...
\begin{document}
	...
	%%%%%%% Daten Versuch
	\setcounter{versuchnr}{243}
	\newcommand{\versuchtitel}{Bestimmung der Boltzmannkonstante mit Hilfe von thermischem Rauschen}
	\newcommand{\protocolpdf}{files/Messprotokoll_243.pdf}
	\newcommand{\titleimg}{files/versuchsaufbau_geraete.png}
	\newcommand{\betreuer}{Anselm de Jonge}
	\newcommand{\datum}{29.10.2024}
  ...
  %\includepdf[scale=0.83,pages=2-,pagecommand={\thispagestyle{plain}}]{\protocolpdf}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\newpage\noindent
	\input{evaluation_analysis}
	
	
	
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%\newpage\noindent
	\input{summary_discussion}

	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\includepdf[scale=0.95,pages=1,pagecommand=\section*{Python Code, Hauptprogramm}]{files/auswertung.pdf}
	\includepdf[scale=0.95,pages=2-,pagecommand={\thispagestyle{plain}}]{files/auswertung.pdf}
